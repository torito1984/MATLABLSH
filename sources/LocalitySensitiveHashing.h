...
PRNearNeighborStructT initLSH_WithDataSet2(RNNParametersT algParameters, Int32T nPoints, PPointT *dataSet);

//void optimizeLSH(PRNearNeighborStructT nnStruct);

void freePRNearNeighborStruct(PRNearNeighborStructT nnStruct);
void freePRNearNeighborStruct2(PRNearNeighborStructT nnStruct);
